...
{
    private static readonly TerrainRgb WaterDeep = new(0.25f, 0.55f, 0.92f);
    private static readonly TerrainRgb WaterShallow = new(0.42f, 0.78f, 0.95f);
    private static readonly TerrainRgb Land = new(0.32f, 0.72f, 0.38f);
    private static readonly TerrainRgb CoastSand = new(0.72f, 0.68f, 0.42f);
        ...
        in TerrainNoiseConfig terrain)
    {
        ...
        if (tile.Override == TerrainOverride.None)
            return FromEvaluator(worldX, worldY, evaluator, terrain);
